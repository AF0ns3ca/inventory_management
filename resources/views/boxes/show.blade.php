    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="w-full p-6 sm:px-20 bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <div class="mt-6 text-gray-500 dark:text-gray-300">
                        <table class="w-full">
                            <thead>
                                <tr>
                                    <th class="text-left">Nombre</th>
                                    <th class="text-left px-6">Acciones</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($box->items as $item)
                                    <tr>
                                        ...
                                        <div class="w-full text-sm text-gray-900 dark:text-gray-100 flex flex-row justify-start items-start gap-2">
