                            ...
                            <tr class="item-row cursor-pointer hover:bg-gray-750" data-id="{{ $item->id }}" data-available="{{ $item->activeLoan() ? 'false' : 'true' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        @else
                                        {{-- enlace a loans create --}}
                                        <a href="{{ route('loans.create', ['item_id' => $item->id]) }}" class="text-green-600 dark:text-green-400 hover:text-green-900 dark:hover:text-green-300 focus:outline-none focus:underline">Loan</a>
                                        @endif
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
